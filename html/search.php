...
<body>
    ...
    <header>
        ...
        <ul class="menu">
            ...
            <li><a id="faha" href="search.php">Search</a><i class="fa fa-search" style="font-size:15px" ></i></li>
...
<br>
    ...
    <!-- Filter form -->
    <div class="search" >
        <a class="arj3" id="close" href="offreopp.php"><span   >&times;</span></a>
    ...
    <div class="advertise">
        ...
        $query = "SELECT o.*, r.* FROM `offre` o JOIN `recruteur` r ON o.id_recruteure = r.id_recruteure WHERE o.naw3 = 'special' AND o.valide = 'V' AND r.sub_exp > CURDATE()";
    ...
    <div class="zayed">
        ...
        <div class="card-contain">
            <?php
            $query = "SELECT o.*, r.* FROM `offre` o JOIN `recruteur` r ON o.id_recruteure = r.id_recruteure WHERE o.naw3 = 'simple' AND o.valide = 'V' AND r.sub_exp > CURDATE()";
            if (!empty($contractType)) {
                $query .= " AND `type_de_contrat` = '$contractType'";
            }
            $get_offers = mysqli_query($conn, $query);
