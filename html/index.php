...
if (isset($_POST['login'])){
  ...
  // Insertion des données dans la base de données
  $sql1 =mysqli_query($conn,"SELECT `id_utilisateur`, `email`, `mot de passe`,`Role` FROM `utilisatuer` WHERE email='$email'AND `mot de passe`='$password' limit 1");
  if (mysqli_num_rows($sql1)) {
    ...
    if($row['Role']=='Simple'){
     ...
     $_SESSION['login_success'] = true;
      ...
      $_SESSION['id_a']=$row['id_utilisateur'];
      $_SESSION['email']=$row['email'];
      $_SESSION['login_success'] = true;
  ...
  echo '<div class="jedi">Email or password incorrect!</div>';
  echo '<script>
          setTimeout(function() {
...
<body>
    ...
    <header>
        ...
        <ul class="menu">
            <li><a id="faha" href="index.php">Home</a></li>
...
<div id="popup" class="popup">
  <p>Login successful!</p>
    ...
    <div class="advertise" >
    <h1>Advertise!</h1>
    <p  class="pp" >Here are some special offers</p>
    <?php
            ...
            <div class="ad_img">
                ...
                <div class="text">
                    <div class="card-details">
                        ...
                        <a href="offreopp.php#'.$row['id_offre'].'"><button class="butn1">Apply</button></a>
                    </div>
